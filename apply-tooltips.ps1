...
$iconHelper = "
        ...
        private void AddInfoIcon(Control label, Control input, ToolTip tip, string text)
        {
            ...
            {
                Text = "🛈", 
                Font = new Font("Segoe UI UI Symbol", 10F, FontStyle.Regular),
                AutoSize = true,
                Cursor = Cursors.Help,
            ...
            icon.Location = new Point(input.Left - 22, label.Top - 2);
            label.Parent.Controls.Add(icon);
            tip.SetToolTip(icon, text);
            tip.SetToolTip(label, text); // also tooltip on main label
            
            icon.MouseEnter += (s, e) => icon.ForeColor = Color.Yellow;
            icon.MouseLeave += (s, e) => icon.ForeColor = Color.FromArgb(150, 150, 150);
        }
"
...
.Replace('private void ApplyNativeDarkMode()', "$iconHelper
