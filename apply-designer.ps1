...
.Replace('private ListBox lstProcesses;', 'private FlowLayoutPanel flpProcesses;')
using System.Windows.Forms;
...
.Replace('private ListBox lstIgnoredWords;', 'private FlowLayoutPanel flpIgnoredWords;')
...
.Replace('private Button btnRemoveProcess;', '')
using System.Windows.Forms;
...
.Replace('private Button btnRemoveIgnoredWord;', '')
...
$oldLstProc = '            // lstProcesses.*?TabIndex = 5;'
$newFlpProc = "            // flpProcesses
...
$oldLstIgnWords = '            // lstIgnoredWords.*?TabIndex = 3;'
$newFlpIgnWords = "            // flpIgnoredWords
...
$oldRemoveProc = '            // btnRemoveProcess.*?Text = "Видалити";'
using System.Windows.Forms;
...
$oldRemoveWord = '            // btnRemoveIgnoredWord.*?Text = "Видалити";'
using System.Windows.Forms;
