...
namespace KeyboardLayoutSwitcher
{
 ...
 -replace 'private System\.Windows\.Forms\.ListBox lstProcesses;', 'private System.Windows.Forms.FlowLayoutPanel flpProcesses;'
using System.Windows.Forms;
...
namespace KeyboardLayoutSwitcher
{
 ...
 -replace 'private System\.Windows\.Forms\.ListBox lstIgnoredWords;', 'private System.Windows.Forms.FlowLayoutPanel flpIgnoredWords;'
using System.Windows.Forms;
...
.Replace('private System.Windows.Forms.Button btnRemoveProcess;', '')
using System.Windows.Forms;
...
.Replace('private System.Windows.Forms.Button btnRemoveIgnoredWord;', '')
...
namespace KeyboardLayoutSwitcher
{
 ...
 -replace 'this\.lstProcesses = new System\.Windows\.Forms\.ListBox\(\);', 'this.flpProcesses = new System.Windows.Forms.FlowLayoutPanel();'
using System.Windows.Forms;
...
namespace KeyboardLayoutSwitcher
{
 ...
 -replace 'this\.lstIgnoredWords = new System\.Windows\.Forms\.ListBox\(\);', 'this.flpIgnoredWords = new System.Windows.Forms.FlowLayoutPanel();'
using System.Windows.Forms;
...
.Replace('this.btnRemoveProcess = new System.Windows.Forms.Button();', '')
using System.Windows.Forms;
...
.Replace('this.btnRemoveIgnoredWord = new System.Windows.Forms.Button();', '')
...
.Replace('this.grpProcesses.Controls.Add(this.lstProcesses);', 'this.grpProcesses.Controls.Add(this.flpProcesses);')
using System.Windows.Forms;
...
.Replace('this.grpProcesses.Controls.Add(this.btnRemoveProcess);', '')
...
.Replace('this.grpIgnoredWords.Controls.Add(this.lstIgnoredWords);', 'this.grpIgnoredWords.Controls.Add(this.flpIgnoredWords);')
using System.Windows.Forms;
...
.Replace('this.grpIgnoredWords.Controls.Add(this.btnRemoveIgnoredWord);', '')

$oldLstProc = '            // lstProcesses.*?lstProcesses\.TabIndex = [0-9]+;'
$newFlpProc = "
            // flpProcesses
            this.flpProcesses.AutoScroll = true;
            this.flpProcesses.Location = new System.Drawing.Point(17, 80);
            this.flpProcesses.Name = "flpProcesses";
            this.flpProcesses.Size = new System.Drawing.Size(474, 49);
            this.flpProcesses.TabIndex = 5;
"
using System.Windows.Forms;
...
namespace KeyboardLayoutSwitcher
{
 ...
 = [System.Text.RegularExpressions.Regex]::Replace(using System.Windows.Forms;
...
, $oldLstProc, $newFlpProc, [System.Text.RegularExpressions.RegexOptions]::Singleline)

$oldLstIgnWords = '            // lstIgnoredWords.*?lstIgnoredWords\.TabIndex = [0-9]+;'
$newFlpIgnWords = "
            // flpIgnoredWords
            this.flpIgnoredWords.AutoScroll = true;
            this.flpIgnoredWords.Location = new System.Drawing.Point(17, 55);
            this.flpIgnoredWords.Name = "flpIgnoredWords";
            this.flpIgnoredWords.Size = new System.Drawing.Size(474, 64);
            this.flpIgnoredWords.TabIndex = 3;
"
using System.Windows.Forms;
...
, $oldLstIgnWords, $newFlpIgnWords, [System.Text.RegularExpressions.RegexOptions]::Singleline)

$oldRemoveProc = '            // btnRemoveProcess.*?btnRemoveProcess\.Text = "Видалити";'
using System.Windows.Forms;
...
, $oldRemoveProc, '', [System.Text.RegularExpressions.RegexOptions]::Singleline)

$oldRemoveWord = '            // btnRemoveIgnoredWord.*?btnRemoveIgnoredWord\.Text = "Видалити";'
using System.Windows.Forms;
...
, $oldRemoveWord, '', [System.Text.RegularExpressions.RegexOptions]::Singleline)
...
.Replace('btnRemoveProcess.Click += BtnRemoveProcess_Click;', '')
using System;
using System.Drawing;
using System.Windows.Forms;
using System.Runtime.InteropServices;
...
.Replace('btnRemoveIgnoredWord.Click += BtnRemoveIgnoredWord_Click;', '')
using System;
using System.Drawing;
using System.Windows.Forms;
using System.Runtime.InteropServices;
...
namespace KeyboardLayoutSwitcher
{
 ...
 -replace 'lstProcesses', 'flpProcesses'
using System;
using System.Drawing;
using System.Windows.Forms;
using System.Runtime.InteropServices;
...
namespace KeyboardLayoutSwitcher
{
 ...
 -replace 'lstIgnoredWords', 'flpIgnoredWords'

$oldLoad = 'flpProcesses\.Items\.Clear\(\);.*?flpIgnoredWords\.Items\.Add\(w\.Trim\(\)\);\s*\}'
$newLoad = "
            flpProcesses.Controls.Clear();
            if (!string.IsNullOrWhiteSpace(settings.ProcessFilterText)) {
                foreach (var p in settings.ProcessFilterText.Split(new[] { '\r', '\n', ',' }, StringSplitOptions.RemoveEmptyEntries)) AddTag(flpProcesses, p.Trim());
            }
            flpIgnoredWords.Controls.Clear();
            if (!string.IsNullOrWhiteSpace(settings.IgnoredWordsText)) {
                foreach (var w in settings.IgnoredWordsText.Split(new[] { '\r', '\n', ',' }, StringSplitOptions.RemoveEmptyEntries)) AddTag(flpIgnoredWords, w.Trim());
            }
"
using System;
using System.Drawing;
...
namespace KeyboardLayoutSwitcher
{
 ...
 = [System.Text.RegularExpressions.Regex]::Replace(using System;
using System.Drawing;
using System.Windows.Forms;
using System.Runtime.InteropServices;
using System.Linq;
...
, $oldLoad, $newLoad, [System.Text.RegularExpressions.RegexOptions]::Singleline)

$oldApply = 'settings\.ProcessFilterText = string\.Join\(Environment\.NewLine, flpProcesses\.Items\.Cast<string>\(\)\);\s*settings\.IgnoredWordsText = string\.Join\(Environment\.NewLine, flpIgnoredWords\.Items\.Cast<string>\(\)\);'
$newApply = "
            settings.ProcessFilterText = string.Join(Environment.NewLine, flpProcesses.Controls.OfType<Control>().Select(c => (string)c.Tag));
            settings.IgnoredWordsText = string.Join(Environment.NewLine, flpIgnoredWords.Controls.OfType<Control>().Select(c => (string)c.Tag));
"
using System;
using System.Drawing;
using System.Windows.Forms;
...
, $oldApply, $newApply, [System.Text.RegularExpressions.RegexOptions]::Singleline)

$oldMethods = '        private void BtnAddProcess_Click.*?private void MainForm_FormClosing'
$newMethods = "
        private void AddTag(FlowLayoutPanel panel, string text)
        {
            var pnl = new Panel { AutoSize = true, AutoSizeMode = AutoSizeMode.GrowAndShrink, BackColor = Color.FromArgb(80, 80, 80), Tag = text, Margin = new Padding(2), Padding = new Padding(0) };
            
            var lbl = new Label { Text = text, AutoSize = true, Location = new Point(3, 4), ForeColor = Color.White };
            pnl.Controls.Add(lbl);

            var btn = new Button { Text = "✕", Size = new Size(20, 20), Margin = new Padding(0), FlatStyle = FlatStyle.Flat, ForeColor = Color.FromArgb(255, 100, 100), Cursor = Cursors.Hand };
            btn.FlatAppearance.BorderSize = 0;
            btn.FlatAppearance.MouseOverBackColor = Color.FromArgb(120, 60, 60);
            btn.Location = new Point(lbl.PreferredWidth + 5, 2);
            btn.Click += (s, e) => { panel.Controls.Remove(pnl); SettingsControlChanged(null, EventArgs.Empty); };
            pnl.Controls.Add(btn);

            pnl.HandleCreated += (s, e) => { btn.Left = lbl.Width + 5; };

            panel.Controls.Add(pnl);
        }

        private bool HasTag(FlowLayoutPanel panel, string text)
        {
            return panel.Controls.OfType<Control>().Any(c => string.Equals((string)c.Tag, text, StringComparison.OrdinalIgnoreCase));
        }

        private void BtnAddProcess_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrWhiteSpace(txtNewProcess.Text) && !HasTag(flpProcesses, txtNewProcess.Text.Trim())) {
                AddTag(flpProcesses, txtNewProcess.Text.Trim());
                txtNewProcess.Clear();
                SettingsControlChanged(null, EventArgs.Empty);
            }
        }
        ...
        private void BtnAddIgnoredWord_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrWhiteSpace(txtNewIgnoredWord.Text) && !HasTag(flpIgnoredWords, txtNewIgnoredWord.Text.Trim())) {
                AddTag(flpIgnoredWords, txtNewIgnoredWord.Text.Trim());
                txtNewIgnoredWord.Clear();
                SettingsControlChanged(null, EventArgs.Empty);
            }
        }
...
, $oldMethods, $newMethods, [System.Text.RegularExpressions.RegexOptions]::Singleline)
